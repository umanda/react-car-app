...
export function TopCars() {
  ...
  const fetchTopCars = async  () => {
    ...
    //await  wait(5000); // Loader testing
  ...
  const testCar3: ICar = {
    ...
    mileage: "30k",
    thumbnailUrl: "https://cdn.jdpower.com/Models/640x480/2021-Toyota-Corolla-LE.jpg",
    dailyPrice: 60,
    monthlyPrice: 1500,
    gearType: "Auto",
    gas: "Petrol",
...
*/
  ...
  const cars =
      (!isEmptyTopCars &&
          topCars.map((car) => <Car {...car} thumbnailUrl={car.thumbnailUrl}/>)) ||
      [];
